...
export const DataIcon = ({ style }: SvgIconProps) => {
  return (
...
export const CableTvIcon = ({ style }: SvgIconProps) => {
  return (
...
export const ElectricIcon = ({ style }: SvgIconProps) => {
  return (
...
export const DropIcon = ({ style }: SvgIconProps) => {
  return (
...
export const GiftIcon = ({ color }: SvgIconProps) => {
  return (
...
export const LoveIcon = ({ style }: SvgIconProps) => {
  return (
    <Svg style={style} width="14" height="12" viewBox="0 0 14 12" fill="none">
      <Path
...
export const SelectIcon = ({ style }: SvgIconProps) => {
  return (
