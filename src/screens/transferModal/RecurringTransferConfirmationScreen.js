...
var RecurringTransferConfirmationScreen = function (_a) {
      ...
      <Themed_1.View style={styles.container}>
        <Themed_1.View>
          ...
          <Themed_1.View style={{ marginBottom: LayoutUtil_1.hp(30) }}>
            ...
            borderBottomWidth: 1,
            borderBottomColor: Colors_1["default"][colorScheme].separator
        }} showSoftInputOnFocus={false} value={NumberUtils_1.numberWithCommas(80000)}/>
            </Themed_1.View>
          </Themed_1.View>
          <Themed_1.View style={{ marginBottom: LayoutUtil_1.hp(30) }}>
            <Themed_1.Text lightColor={Colors_1["default"].light.secondaryText} darkColor={Colors_1["default"].dark.secondaryText} style={{
            ...
            borderBottomWidth: 1,
            borderBottomColor: Colors_1["default"][colorScheme].separator
        }} showSoftInputOnFocus={false} value={"Weekly"}/>
          </Themed_1.View>
          <Themed_1.View style={{ marginBottom: LayoutUtil_1.hp(30) }}>
            <Themed_1.Text lightColor={Colors_1["default"].light.secondaryText} darkColor={Colors_1["default"].dark.secondaryText} style={{
            fontFamily: "Euclid-Circular-A",
            ...
            borderBottomWidth: 1,
            borderBottomColor: Colors_1["default"][colorScheme].separator
        }} showSoftInputOnFocus={false} value={"Wednesday"}/>
          </Themed_1.View>
        </Themed_1.View>
        <Themed_1.View style={[CommonStyles_1["default"].col, { marginBottom: LayoutUtil_1.hp(50), width: "100%" }]}>
          <Button_1["default"] title="Continue" onPressButton={function () {
            return navigation.push("StatusScreen", {
                status: "Successful",
                statusIcon: "Success",
...
exports["default"] = RecurringTransferConfirmationScreen;
