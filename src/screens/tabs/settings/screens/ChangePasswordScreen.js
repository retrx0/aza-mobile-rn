...
var ChangePasswordScreen = function (_a) {
    ...
    return (<Themed_1.View style={styles.container}>
      ...
      <Themed_1.View style={{ marginBottom: 60, marginTop: 80, marginLeft: -20 }}>
        <SegmentedInput_1["default"] value={password} secureInput headerText="Password" onValueChanged={function (pass) { return setPassword(pass); }}/>
      </Themed_1.View>
      <Button_1["default"] title="Continue" onPressButton={function () { return navigation.navigate("NewPassword"); }} styleText={{
