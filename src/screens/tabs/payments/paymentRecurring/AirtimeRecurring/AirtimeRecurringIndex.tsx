...
import AirtimeRecurring from "./AirtimeRecurring";
import DataBundleRecurring from "./DataBundleRecurring";
...
const AirtimeDataRecurring = ({
  ...
  const renderScene = (props: any) => {
    switch (props.route.key) {
      case "first":
        return <AirtimeRecurring navigation={navigation} route={route} />;
      case "second":
        return <DataBundleRecurring navigation={navigation} route={route} />;
    }
  };
...
export default AirtimeDataRecurring;
