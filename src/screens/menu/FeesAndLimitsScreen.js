...
var AccountLimitsTab_1 = require("./components/AccountLimitsTab");
var TransactionFeesTab_1 = require("./components/TransactionFeesTab");
var FeesAndLimitsScreen = function (_a) {
    ...
    var renderScene = function (props) {
        switch (props.route.key) {
            case "first":
                return <TransactionFeesTab_1["default"] />;
            case "second":
                return <AccountLimitsTab_1["default"] navigation={navigation} route={route}/>;
        }
    };
    return (<>
...
exports["default"] = FeesAndLimitsScreen;
