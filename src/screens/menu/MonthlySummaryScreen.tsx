          ...
          >
                  ...
                  >
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            transactionType === "debit" ? "#FF361A" : "#2AD168",
                        },
                      ]}
                    >
                    ...
                    {transactionDetails?.map((transaction, i, { length }) => (
                      ...
                      >
                        ...
                        >
                          {transactionDetailsIcons[transaction.detailIconName]}
                        </View>
                        <Text
                          style={[
                            styles.detailAmount,
            ...
            <View style={styles.chartContainer}>
              ...
              <View style={styles.chartLegendContainer}>
                {currentSummariesToShow.chartData.map(({ color, text }, i) => (
                  <View
                    key={i}
                    style={[
                      CommonStyles.row,
            ...
            >
              ...
              <Text style={styles.donationAmount}>
                {"\u20A6"}{" "}
                {numberWithCommas(currentSummariesToShow.totalWorthOfDonations)}
              </Text>
              <Text
                style={[
                  styles.donationText,
