...
var OutgoingSplitRequestsScreen = function (_a) {
        ...
        <react_native_1.ScrollView>
          <Themed_1.View style={[CommonStyles_1["default"].col, { alignSelf: "stretch" }]}>
            ...
            fontFamily: "Euclid-Circular-A-Medium"
              ...
              <SplitPaymentStatus_1["default"] paid={false}/>
            </Themed_1.View>
          </Themed_1.View>
        </react_native_1.ScrollView>
        <Themed_1.View style={[CommonStyles_1["default"].col, { width: "100%", marginBottom: LayoutUtil_1.hp(35) }]}>
          <Button_1["default"] title="Cancel Request" onPressButton={function () { return navigation.navigate("Split"); }} styleText={{
            fontFamily: "Euclid-Circular-A-Medium",
            fontSize: 14
        }} style={{
            marginVertical: 10,
            ...
            backgroundColor: Colors_1["default"][colorScheme].error
        }}/>
        </Themed_1.View>
      </Themed_1.View>
    </SpacerWrapper_1["default"]>);
};
exports["default"] = OutgoingSplitRequestsScreen;
