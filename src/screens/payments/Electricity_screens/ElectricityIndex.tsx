...
export default function ElectricityIndex({navigation}:{navigation:{navigate:any}}) {
  ...
  return (
    ...
    headerStyle={null} heading='Select electricity provider'/>
    ...
    <Input icon={null} keyboardType='phone-pad'  inputStyle={styles.input} labelStyle={styles.label} label='Meter Number' 
