...
export default function CableTvIndex({navigation}:{navigation:{navigate:any}}) {
  ...
  return (
    ...
    headerStyle={null} heading='Select Cable TV'/>
   
    <ScrollView horizontal style={CommonStyles.imageHeaderContainer}>
    <HeadrImage 
    selected
    index={0} 
    image={require('../../../../assets/images/ie.png')} title='IE'/>
  
    </ScrollView>
    

    <SelectInput items={bundles} title='Subscription Package'
     placeHolder='Choose a subscription package' style={styles.select}/>

    <Input icon={null} keyboardType='phone-pad'  inputStyle={[styles.input]} 
    labelStyle={styles.label} label='Smart Card Number' 
