...
export default function AirtimeIndex({navigation}:{navigation:{navigate:any}}) {
  ...
  return (
    ...
    <HeadrImage selected={selected} onSelect={()=>{
      setSelected(true)
    }}  index={0} image={require('../../../../assets/images/mtn.png')} title='MTN'/>
    <HeadrImage selected={false} index={1} image={require('../../../../assets/images/glo.png')} title='Glo'/>
    </ScrollView>
    <Input 
     icon={null} keyboardType='phone-pad' 
      inputStyle={styles.input} labelStyle={styles.label}
      style={{marginTop:0}}
       label='Phone Number' placeholder='Enter a phone number'/>
