...
export default function Confirmation({navigation}:{navigation:{navigate:any}}) {
  ...
  return (
    <SafeAreaView style={[CommonStyles.parentContainer,styles.container,{paddingTop:Platform.OS=='android'?100:0}]}>
        <Text style={styles.txt}>
        Kindly confirm the details of this transaction
        </Text>
        <ImageInput/>
        <Input icon={null} keyboardType='phone-pad' 
         inputStyle={styles.input} labelStyle={null} 
         label='Phone Number' placeholder='08164942224'/>

<Input icon={null} keyboardType='phone-pad' 
         inputStyle={styles.input} labelStyle={null} 
         label='Amount' placeholder='N2,000 (Airtime)'/>

<Input icon={null} keyboardType='phone-pad' 
         inputStyle={styles.input} labelStyle={null} 
         label='Payment Method' placeholder='Aza Account'/>
